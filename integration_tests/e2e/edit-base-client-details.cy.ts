...
context('Edit base client details page - authorization-code flow', () => {
  ...
  it('User can see authorization code form inputs', () => {
    ...
    editBaseClientDetailsPage.grantMfaRadioNone().should('exist')
    editBaseClientDetailsPage.grantMfaRadioAll().should('exist')
    editBaseClientDetailsPage.grantMfaRadioUntrusted().should('exist')
    editBaseClientDetailsPage.grantMfaRememberMeFlowCheckboxes().should('exist')
  })
})
